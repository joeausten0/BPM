...
function preload() {
  ...
  overlayImg = loadImage('dance.png', img => {
    img.resize(700, 500); // Resize the illustration so it's not too big
    img.resize(700, 500); // Or whatever you like
  });
}
...
rowOffset += direction * 2;  // Move row left/right
...
for (let i = 0; i < numFigures; i++) {
  let x = startX + rowOffset + i * figureSpacing;
